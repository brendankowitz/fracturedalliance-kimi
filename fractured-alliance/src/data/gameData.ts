import type {
  RaceDef, OreDef, BuildingDef, BlueprintDef, AsteroidDef,
  ShipClassDef, AgentDef, MerchantItem, BlackMarketItem, EventFeedItem, SaveSlot,
} from '../types';
...
export const ASTEROIDS: AsteroidDef[] = [
...
export const BLACK_MARKET: BlackMarketItem[] = [
...
export const EVENT_FEED: EventFeedItem[] = [
...
export const byId = <T extends { id: string }>(arr: T[], id: string): T | undefined => arr.find(x => x.id === id);
