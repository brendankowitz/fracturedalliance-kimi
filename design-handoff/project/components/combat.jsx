// combat.jsx — Tactical command / fleet engagement screen
// Left: fleet roster. Center: tactical viewport with engagement. Right: order panel.
...
function FleetRoster({ selected, onSelect }) {
  const fleets = [
    {
...
function ShipChip({ ship }) {
  const cls = window.GameData.SHIP_CLASSES.find(c => c.id === ship.kind);
  return (
    <div style={{
        ...
        <g>
          ...
          <g transform="translate(28, 58)">
            <foreignObject x="-3.5" y="-3.5" width="7" height="7">
              <div xmlns="http://www.w3.org/1999/xhtml" style={{ color: 'var(--warn)', display: 'flex' }}>
          ...
          {[[44,46],[47,44],[50,42],[43,42],[46,40],[49,38]].map(([x,y], i) => (
            <g key={i} transform={`translate(${x}, ${y})`}>
              <foreignObject x="-1.5" y="-1.5" width="3" height="3">
                <div xmlns="http://www.w3.org/1999/xhtml" style={{ color: 'var(--warn)', opacity: 0.85, display: 'flex' }}>
        ...
        <g>
          ...
          <g transform="translate(68, 42)">
            <foreignObject x="-3.5" y="-3.5" width="7" height="7" transform="rotate(180)">
              <div xmlns="http://www.w3.org/1999/xhtml" style={{ color: 'var(--crit)', display: 'flex' }}>
          ...
          {[[62,40],[60,44],[64,46],[58,42]].map(([x,y], i) => (
            <g key={i} transform={`translate(${x}, ${y})`}>
              <foreignObject x="-2" y="-2" width="4" height="4" transform="rotate(180)">
                <div xmlns="http://www.w3.org/1999/xhtml" style={{ color: 'var(--crit)', opacity: 0.9, display: 'flex' }}>
                  <ShipGlyph kind="eagle" size={4} />
                </div>
              </foreignObject>
            </g>
